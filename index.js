...
app
  .get("/", (req, res) => {
    res.status(404).send(`Available endpoints:<br />
GET /xws?url=YOUR_URL <br />
POST /xws (put list URL in "url" value in body) <br />
and <br />
/api/v1 GraphQL`);
  })
  .get("/xws", (req, res) => {
  ...
  .post("/xws", (req, res) => {
    ...
    if (!url) {
      res.status(400).send("Missing required variable `url`");
      return;
    }
